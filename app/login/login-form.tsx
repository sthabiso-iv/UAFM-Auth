      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <div className="w-full bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-6">
          ...
          <button
            ...
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-700 font-medium text-sm transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {signingIn ? (
